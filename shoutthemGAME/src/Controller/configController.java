...
public class configController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		/*
		 * Droite.focusedProperty().addListener(new ChangeListener<Boolean>() {
		 * 
		 * @Override public void changed(ObservableValue<? extends Boolean> arg0,
		 * Boolean oldval, Boolean newval) { // TODO Auto-generated method stub if
		 * (newval) {
		 * 
		 * veriftouche=Droite; System.out.println("Textfield on focus"+Droite.getId());
		 * }
		 * 
		 * 
		 * }
